...
namespace HTNColors
{
	namespace NodeBody
	{
		...
		const FLinearColor Task(0.715f, 0.24f, 0.055f);
		const FLinearColor TaskSpecial(0.715f, 0.24f, 0.055f);
	...
	namespace NodeBorder
	{
		...
		const FLinearColor DebugPastPartOfPlan(0.4f, 0.4f, 0.0f);
		const FLinearColor DebugFuturePartOfPlan(1.0f, 1.0f, 0.0f);
		const FLinearColor DebugExecuting(0.0f, 1.0f, 0.0f);
