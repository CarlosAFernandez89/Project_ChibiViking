...
{
	UI_COMMAND(OpenPluginWindow, "HTN", "Bring up HTN window", EUserInterfaceActionType::Button, FInputGesture());
}

FHTNDebuggerCommands::FHTNDebuggerCommands()
	: TCommands<FHTNDebuggerCommands>("HTNEditor.Debugger", LOCTEXT("Debugger", "Debugger"), NAME_None, FEditorStyle::GetStyleSetName())
{}
