...
public:
	...
	virtual void MakePlanExpansions(struct FHTNPlanningContext& Context) override;
	...
	void OnSubLevelFinished(UHTNComponent& OwnerComp, const FHTNPlanStepID& ThisStepID, int32 FinishedSubLevelIndex);
