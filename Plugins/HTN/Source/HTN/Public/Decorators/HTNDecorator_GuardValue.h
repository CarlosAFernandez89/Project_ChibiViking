...
protected:
	...
	bool RestoreWorldstateValue(UHTNComponent& OwnerComp, UWorldStateProxy& WorldStateProxy, const FHTNPlan& CurrentPlan, const FHTNPlanStepID& CurrentStepID) const;
